...
import (
	...
	Controller "todo-backend/src/services/signup-api/controllers"
...
// 	json.NewEncoder(w).Encode(msg{Title: "Hello, World!!"})
// }

func main() {

	// mainRoute := Service.BindRoute{"/", home, "GET"}

	// routes := []Service.BindRoute{mainRoute}
